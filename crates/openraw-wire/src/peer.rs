//! PeerNode — TCP server and client for the OpenRaw Wire Protocol.
//!
//! A [`PeerNode`] binds a local TCP listener and accepts incoming connections
//! from other OpenRaw kernels. It also connects outward to known peers. Each
...
impl Default for PeerConfig {
    fn default() -> Self {
        Self {
            ...
            node_name: "openraw-node".to_string(),
...
mod tests {
    ...
    fn test_peer_config_default() {
        ...
        assert_eq!(config.node_name, "openraw-node");
