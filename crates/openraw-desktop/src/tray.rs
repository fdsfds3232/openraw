//! System tray setup for the OpenRaw desktop app.
...
pub fn setup_tray(app: &tauri::App) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let quit = MenuItem::with_id(app, "quit", "Quit OpenRaw", true, None::<&str>)?;
                    ...
                    match crate::updater::check_for_update(&app_handle).await {
                        Ok(info) if info.available => {
                            ...
                            let _ = app_handle
                                ...
                                .body(format!(
                                    "Downloading OpenRaw v{version}. App will restart shortly."
                                ))
                                .show();
                            // Perform install
                            if let Err(e) =
                        ...
                        Ok(_) => {
                            let _ = app_handle
                                ...
                                .builder()
                                .title("Up to Date")
                                .body("You're running the latest version of OpenRaw.")
                                .show();
                        }
                        Err(e) => {
