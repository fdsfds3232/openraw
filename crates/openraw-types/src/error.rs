//! Shared error types for the OpenRaw system.

use thiserror::Error;

/// Top-level error type for the OpenRaw system.
#[derive(Error, Debug)]
pub enum OpenRawError {
...
/// Alias for Result with OpenRawError.
pub type OpenRawResult<T> = Result<T, OpenRawError>;
