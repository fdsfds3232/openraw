...
mod tests {
    ...
    fn env_var_requirement_check() {
        std::env::set_var("OPENRAW_TEST_HAND_REQ", "test_value");
        let req = HandRequirement {
            key: "test".to_string(),
            label: "test".to_string(),
            requirement_type: RequirementType::EnvVar,
            check_value: "OPENRAW_TEST_HAND_REQ".to_string(),
            description: None,
            install: None,
        };
        ...
        let req_missing = HandRequirement {
            ...
            label: "test".to_string(),
            requirement_type: RequirementType::EnvVar,
            check_value: "OPENRAW_NONEXISTENT_VAR_12345".to_string(),
            description: None,
            install: None,
        };
        assert!(!check_requirement(&req_missing));
        std::env::remove_var("OPENRAW_TEST_HAND_REQ");
    }
}
