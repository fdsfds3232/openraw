...
use base64::Engine;
use openraw_types::media::{GeneratedImage, ImageGenRequest, ImageGenResult};
use tracing::warn;
...
pub async fn generate_image(request: &ImageGenRequest) -> Result<ImageGenResult, String> {
    ...
    if request.model == openraw_types::media::ImageGenModel::DallE3 {
...
mod tests {
    use super::*;
    use openraw_types::media::ImageGenModel;
