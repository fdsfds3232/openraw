...
use openraw_types::config::DockerSandboxConfig;
use std::path::Path;
...
mod tests {
    ...
    fn test_sanitize_container_name_valid() {
        let result = sanitize_container_name("openraw-sandbox-abc123").unwrap();
        assert_eq!(result, "openraw-sandbox-abc123");
    }
    ...
    fn test_config_defaults() {
        ...
        assert_eq!(config.container_prefix, "openraw-sandbox");
