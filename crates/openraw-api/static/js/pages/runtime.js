// Runtime page вЂ” system overview and provider status
      ...
      async loadData() {
        ...
        try {
          var results = await Promise.all([
            OpenRawAPI.get('/api/status'),
            OpenRawAPI.get('/api/version'),
            OpenRawAPI.get('/api/providers'),
            OpenRawAPI.get('/api/agents')
          ]);
