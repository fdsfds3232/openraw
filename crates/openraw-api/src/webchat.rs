...
const ETAG: &str = concat!("\"openraw-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the OpenRaw logo.
...
/// GET /favicon.ico — Serve the OpenRaw favicon.
...
/// GET / — Serve the OpenRaw Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the OpenRaw Dashboard.
///
