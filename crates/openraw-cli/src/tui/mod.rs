//! Ratatui TUI for OpenRaw interactive mode.
//!
...
enum Backend {
    ...
    InProcess { kernel: Arc<OpenRawKernel> },
    None,
}
...
impl App {
    ...
    fn handle_stream_done(
        &mut self,
        result: Result<openraw_runtime::agent_loop::AgentLoopResult, String>,
    ) {
    ...
    fn handle_kernel_ready(&mut self, kernel: Arc<OpenRawKernel>) {
