//! Color palette matching the OpenRaw landing page design system.
//!
...
pub const ACCENT: Color = Color::Rgb(240, 239, 238); // #F0EFEE — white/light (black & white theme)
pub const ACCENT_DIM: Color = Color::Rgb(168, 162, 158); // #A8A29E — muted
