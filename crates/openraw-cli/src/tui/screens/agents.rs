...
pub struct InProcessAgent {
    pub id: openraw_types::agent::AgentId,
    pub name: String,
    pub state: String,
    pub provider: String,
    pub model: String,
...
impl AgentSelectState {
    ...
    pub fn load_inprocess_agents(&mut self, kernel: &openraw_kernel::OpenRawKernel) {
...
fn truncate(s: &str, max: usize) -> String {
    if s.len() <= max {
        ...
        format!("{}\u{2026}", openraw_types::truncate_str(s, max.saturating_sub(1)))
    }
}
