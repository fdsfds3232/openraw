...
impl Default for MarketplaceConfig {
    fn default() -> Self {
        Self {
            ...
            github_org: "openraw-skills".to_string(),
        }
    }
}
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.github_org, "openraw-skills");
    }

    #[test]
    fn test_client_creation() {
        let client = MarketplaceClient::new(MarketplaceConfig::default());
        assert_eq!(client.config.github_org, "openraw-skills");
    }
}
