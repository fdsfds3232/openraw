...
All notable changes to OpenRaw will be documented in this file.
...
#### Client SDKs
- JavaScript SDK (`@openraw/sdk`): full REST API client with streaming, TypeScript declarations
- Python client SDK (`openraw_client`): zero-dependency stdlib client with SSE streaming
- Python agent SDK (`openraw_sdk`): decorator-based framework for writing Python agents
...
- MCP server (exposes OpenRaw tools via MCP protocol)
...
[0.1.0]: https://github.com/RightNow-AI/openraw/releases/tag/v0.1.0
