# OpenRaw Documentation

Welcome to the OpenRaw documentation. OpenRaw is the open-source Agent Operating System -- 14 Rust crates, 40 channels, 60 skills, 20 LLM providers, 76 API endpoints, and 16 security systems in a single binary.
...
| Path | Description |
|------|-------------|
| `~/.openraw/config.toml` | Main configuration file |
| `~/.openraw/data/openraw.db` | SQLite database |
| `~/.openraw/skills/` | Installed skills |
| `~/.openraw/daemon.json` | Daemon PID and port info |
